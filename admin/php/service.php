    ...
    <div class="container px-28 py-5">
        <table>
            ...
            <tbody>
                ...
                $data = "SELECT * FROM service ORDER BY id DESC";
                $val = $con->query($data);
                $i = 1;
                if ($val->num_rows > 0) {
                  while ($row = $val->fetch_assoc()) {
                    ...
                    echo "<td><a href='delete-service.php?id={$row['id']}' class='button'>Delete</a></td>";
                    echo "<td><a href='edit-service.php?id={$row['id']}' class='button'>Edit</a></td>";
                    echo "</tr>";
                  }
                } else {

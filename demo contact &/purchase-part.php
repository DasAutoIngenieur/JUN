...
<body class="bg-black">
        ...
        <div class="flex-items-center justify-center text-left py-6 px-28">
            <div class="max-w-md mx-auto mt-10 bg-white p-6 py-5 rounded-lg shadow-md">
                ...
                <form action="#" method="POST">
                    ...
                    <div class="mb-6">
                        <label for="name" class="exo-2-regular text-gray-700 font-medium mb-2">Car-Part</label>
                        <input type="name" id="name" name="part" class="exo-2-regular w-full px-4 py-2 rounded-lg shadow-sm focus:outline-none" placeholder="Choose a Car-part">
                    </div>
                    <div class="mb-6">
    ...
    if(isset($_POST['sub'])) {
        ...
        $query = "INSERT INTO `parts` VALUES ('', '$name', '$email', '$phone', '$part')";
        $con->query($query); 

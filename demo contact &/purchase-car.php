        ...
        <div class="flex-items-center justify-center text-left py-6 px-28">
            <div class="max-w-md mx-auto mt-10 bg-white p-6 py-5 rounded-lg shadow-md">
                ...
                <form action="#" method="POST">
                    ...
                    <div class="mb-6">
                        <label for="name" class="exo-2-regular text-gray-700 font-medium mb-2">Car to Test Drive</label>
                            <select id="car" name="car" class="exo-2-regular w-full px-4 py-2 rounded-lg shadow-sm focus:outline-none" required>
                                <option class="text-gray-300" value="" disabled selected>>Car Selection<</option>
                                <option value="v6silvia">V6 S15 Super Silvia</option>
                                <option value="v12supra">V12 Super Supra</option>
                                <option value="lrsilvia">Box-6 Long-ratio Gears Silvia Q</option>
                                <option value="s12silvia">Straight 12 Silvia S10</option>
                            </select>
                    </div>
                    <div class="mb-6">
                        <label for="name" class="exo-2-regular text-gray-700 font-medium mb-2">Phone</label>
                        <input type="text" id="name" name="phone" class="exo-2-regular w-full px-4 py-2 rounded-lg shadow-sm focus:outline-none" placeholder="Your Phone">
                    </div>

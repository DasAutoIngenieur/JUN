...
<body class="bg-black">
            ...
            <div class="max-w-md mx-auto mt-10 bg-white p-6 py-5 rounded-lg shadow-md">
                ...
                <form action="#" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="service" name="service" class="exo-2-regular w-full px-4 py-2 rounded-lg shadow-sm focus:outline-none">
                    </div>
                    <div class="mb-4">
                        <label for="name" class="exo-2-regular text-gray-700 font-medium mb-2">Request</label>
                        <input type="text" id="request" name="request" class="exo-2-regular w-full px-4 py-2 rounded-lg shadow-sm focus:outline-none">
                    </div>
    ...
    if(isset($_POST['sub'])) {
        ...
        $query = "INSERT INTO `service` VALUES ('', '$name', '$email', '$service', '$request')";
        $con->query($query); 
